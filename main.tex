...
\begin{figure}[htbp]
   ...
   \subfloat[]{
        ...
        \includegraphics[scale=0.3]{img/200m/resul/200_XZ_velocidad_corte_centro_pozo1}}
   \hspace{0.1\linewidth}
   %%----segunda subfigura----
   \subfloat[]{
        \label{200_XZ_velocidad_corte_centro_pozo2}         %% Etiqueta para la segunda subfigura
        \includegraphics[scale=0.3]{img/200m/resul/200_XZ_velocidad_corte_centro_pozo2}}

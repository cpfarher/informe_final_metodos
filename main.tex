...
\begin{figure}[tbhp]
\centerline{\includegraphics[scale=0.5]{img/100m/100_xy_contorno_malla}}
\caption{Mallado generada para \emph{G1}- Vista plano XY}
\label{100_xy_contorno_malla}
\end{figure}
%
\begin{figure}[tbhp]
\centerline{\includegraphics[scale=0.5]{img/200m/200_xy_contorno_malla}}

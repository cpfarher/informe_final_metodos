...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Acuífero libre, homogéneo e isótropo $(K_x = K_y = K_z)$ \begin{Large}
...
En estas superficies se fija la velocidad $V_z$ a $0$ (para representar la impermeabilidad de la superficie superior e inferior del campo). En las direcciones de $x$ y $y$ el movimiento es libre.

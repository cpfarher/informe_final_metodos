...
En un acuífero no confinado, en cambio, el agua no está almacenada a presión por no estar encapsulada en la roca. Si se hiciera un pozo en él, el agua se tendría que bombear a la superficie.
En el presente trabajo, se presentan los resultados de la simulación de un campo de bombeo en medios porosos en un acuífero

\begin{LARGE} ver si el acuifero es libreo o confinado!!!!!!!!! \end{LARGE}
...
En tanto que el diámetro de los pozos se amplificó por un factor de 40. \begin{LARGE}
ver esto!!! 0.5m diametro original -> 0.5m*40 = 20 m que es lo que esta en la geometria
\end{LARGE}\\
...
Entre los valores que se encuentran entre 500 y 50000 la velocidad es constante igual a la velocidad de extracción que posee el pozo.
...
\end{eqnarray}
La función escrita para el $ValorZ$ en (\ref{pozo1_funcion}) se puede observar en la figura \ref{grafica1_0085}. 

\begin{figure}[tbhp]
\centerline{\includegraphics[scale=0.3]{graficas/grafica1_0085}}
\caption{Función tiempo vs. velocidad de campo de velocidad en Z representada en (\ref{pozo1_funcion})}
\label{grafica1_0085}
\end{figure}
...
\end{eqnarray}
La función escrita para el $ValorZ$ en (\ref{pozo2_funcion}) se puede observar en la figura \ref{grafica1_0057}. 

\begin{figure}[tbhp]
\centerline{\includegraphics[scale=0.3]{graficas/grafica1_0057}}
\caption{Función tiempo vs. velocidad de campo de velocidad en Z representada en (\ref{pozo2_funcion})}
\label{grafica1_0057}
\end{figure}
